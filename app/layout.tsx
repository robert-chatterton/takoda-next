      ...
      <body className="min-h-full flex flex-col font-sans">
        <header className="fixed top-0 left-0 right-0 z-50 bg-neutral-950/80 backdrop-blur-sm border-b border-neutral-900">
          <nav className="max-w-4xl mx-auto px-6 h-16 flex items-center justify-between">
            <Link href="/" className="font-semibold text-lg opacity-70 hover:opacity-100 transition-opacity">
              {LOWER_ARTIST_NAME}
            </Link>
            <div className="hidden md:flex gap-8">
              ...
              <Link href="/upcoming-shows" className="flex flex-row items-center gap-1 text-neutral-100 opacity-70 hover:opacity-100 transition-opacity text-sm">
                <MicVocal className="w-4 h-4" />
                upcoming shows
              </Link>
              <Link href="/bio" className="flex flex-row items-center gap-1 text-neutral-100 opacity-70 hover:opacity-100 transition-opacity text-sm">
